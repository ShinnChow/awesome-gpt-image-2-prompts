...
Это тщательно отобранная коллекция из **881+ качественных промптов GPT-Image-2**, паттернов работы с API и переиспользуемых визуальных workflow для генерации изображений с AI.
...
👉 **[Все 20 prompt case для e-commerce →](cases/ecommerce.md)**
...
👉 **Все 119 prompt case для постеров и иллюстраций →**
