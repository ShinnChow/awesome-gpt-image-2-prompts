...
Esta é uma coleção curada de **881+ prompts GPT-Image-2 de alta qualidade**, padrões de uso da API e fluxos visuais reutilizáveis para geração de imagens com IA.
...
> **22 casos selecionados** — [Explorar todos os prompts de criativos publicitários →](cases/ad-creative.md)
...
> **124 casos curados** — [Explore todos os prompts de retrato →](cases/portrait.md)
...
> **143 casos selecionados** — [Explorar todos os prompts de pôster →](cases/poster.md)
...
> **38 casos selecionados** — [Explorar todos os prompts de UI e mockup →](cases/ui.md)
