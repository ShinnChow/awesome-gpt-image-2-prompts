...
> **엄선된 사례 22개** — [모든 광고 크리에이티브 프롬프트 보기 →](cases/ad-creative.md)
...
> **엄선된 사례 124개** — [모든 인물 프롬프트 보기 →](cases/portrait.md)
...
> **엄선된 사례 143개** — [모든 포스터 프롬프트 보기 →](cases/poster.md)
...
> **엄선된 사례 38개** — [모든 UI 및 목업 프롬프트 보기 →](cases/ui.md)
